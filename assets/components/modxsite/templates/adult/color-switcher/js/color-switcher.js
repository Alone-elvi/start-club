...
jQuery(document).ready(function($) {
	...
	var colors = '';
	var server_url = '../../../../../../demo.thememascot.com/lara/demo/css/colors/'; 
    ...
    $('#switcher-layout-mode a').on('click', function(e) {
        ...
        if( layout_mode == "wide" ) {
            $('body').removeClass('bg-gray-light').removeClass('boxed-layout').removeClass('pt-40').removeClass('pb-40');
    ...
    $('#switcher-bgcolor a').on('click', function(e) {
        ...
        if( bgcolor == "dark" ) {
            ...
            $('#header .menuzord-brand img').attr('src','images/logo-wide.png');
        }
        return false;
    });
